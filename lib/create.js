...
async function create (projectName, options) {
  const spinner = ora(chalk.yellow(`Creating directory and initializing with ${options.packageManger}...`)).start();
  ...
  spinner.succeed(chalk.bgGreen.bold(`Creating directory and initializing with ${options.packageManger}...`));
